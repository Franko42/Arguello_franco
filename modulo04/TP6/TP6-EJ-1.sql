...
VALUES  ("Venezuela", true), ("Argentina", true),  ("Peru", true),  ("Chiled",true), ("Bolivia", true);

INSERT INTO provincias (nombre, idpais)
VALUES		("masachussets", 1), ("texas", 1), ("ohio", 1), ("oregon", 4), ("california", 5);
...
VALUES  ("Abert", "Einstein", "20-52513512-9", "Berlin", 2), ("Isaac", "Newton", "20-52513512-9", "Paris", 5), ("Stephen", "Hawkings", "20-52513512-9", "Moscú", 12), ("Marie", "Curie", "20-52513512-9", "Paris", 1), ("Galileo", "Galilei", "20-52513512-9", "Atenas", 3)  ;

INSERT INTO movimientos (cantidad, fecha, id_cliente, id_vendedor, id_producto, estado,  tipo_movimiento)
VALUES (150, "2022/11/10", 1, 1, 1, True, "ingreso"), (200, "2022/11/10", 2, 2, 2, True, "egreso"), (100, "2022/11/10", 3, 3, 3, true, "pedido"), (250, "2022/11/10", 4, 4, 4, true, "ingreso"), (50, "2022/11/10", 5, 5, 5,false, "egreso");
...
UPDATE movimientos  SET estado = 0 where tipo_movimiento = "egreso" ;
UPDATE paises SET estado = 0 where id = 1;

UPDATE productos SET stock = 500 + 150  WHERE id = 1 ;
UPDATE productos SET stock = 7500 - 200 WHERE id = 2 ;
UPDATE productos SET stock = 300  WHERE id = 3;
UPDATE productos SET stock = 500 + 250 WHERE id = 4;
UPDATE productos SET stock = 100 - 50 WHERE id = 5;
...
INSERT INTO parametros (cosas, id_usuario)
VALUES 
